...
**Group Member**
```
侯嘉琪, Ngoc Anh - Phan (Mia), Bryan Tjandra
```

**Task Division**
```
Bryan Tjandra: core gameplay and systems — engine, building, stairs, mission chain, combat, companions, co-op, tests, landing page and docs; Ngoc Anh - Phan (Mia): experience, UI and story — survival-horror overhaul, six-floor story, chapter comics, mission window, respawn flow; 侯嘉琪: audio — recorded sound effects, heartbeat and tension system, helicopter and thunder.
```
...
- Team **Rooftop Escape**: 侯嘉琪 (GitHub `hallucinate`), Ngoc Anh - Phan (Mia) (GitHub `saltymiaaaa`), Bryan Tjandra. Fill in the student IDs before you submit.
